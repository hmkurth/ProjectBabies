<?php
   ...
   require_once('navmenu.php');
      ...
      function build_query($user_search, $sort)
      {
        ...
        switch ($sort) {
        // Ascending by resource type
        case 1:
          $search_query .= " ORDER BY type";
          break;
        // Descending by resource title
        case 2:
          $search_query .= " ORDER BY type DESC";
          break;
      ...
      function generate_sort_links($user_search, $sort) {
        ...
        switch ($sort) {
        case 1:
          $sort_links .= '<th><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=2">Posting Type/a></th><th>Description</th>';
          $sort_links .= '<th><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=3">Title</a></th><th>Contact Name</th><th>Email</th>';
          $sort_links .= '<th><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=5">Date Posted</a></th>';
          break;
        case 3:
          $sort_links .= '<th><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=1">Posting Type</a></th><th>Description</th>';
          $sort_links .= '<th><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=4">Title</a></th><th>Contact Name</th><th>Email</th>';
        ...
        case 5:
          ...
          break;
        default:
          $sort_links .= '<th><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=1">Posting Type</a></th><td>Description</th>';
          $sort_links .= '<th><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=3">Title</a></th><th>Contact Name</th><th>Email</th>';
          $sort_links .= '<th><a href = "' . $_SERVER['PHP_SELF'] . '?usersearch=' . $user_search . '&sort=5">Date Posted</a></th>';
        }
    ...
    isset($_GET['sort']) ? $sort = $_GET['sort'] : $sort = '';
      ...
      while ($row = mysqli_fetch_array($result)) {
        ...
        echo '<td valign="top">' . substr($row['description'], 0, 10) . '</td>';
        echo '<td valign="top">' . substr($row['title'], 0, 100) . '...</td>';
